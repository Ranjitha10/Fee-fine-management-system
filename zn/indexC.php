...
<body>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="WPfeedetails.php">Fee/Fine Details</a></li>
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <div class="row">
                <a href="studentdetails.php"> <div class="col-md-4 col-sm-4 col-xs-7">
  ...
  <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                ...
                <a href="feedetails.php"> <div class="col-md-4 col-sm-4 col-xs-7">
  ...
  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
                         ...
                         <h5>Fee/Fine Details </h5>
                    </div></a>
                </div>
                <a href="notiC.php"><div class="col-md-4 col-sm-4 col-xs-7">
