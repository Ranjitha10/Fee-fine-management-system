...
function showinfo(){
	var xmlhttp = new XMLHttpRequest();
		...
		xmlhttp.open('GET','wpnoti.php',true);
		xmlhttp.send();
...
<div class="row">	
	...
	<div class="col-md-6">
                          ...
                          <div class="alert alert-warning">
                            <button class="btn btn-warning" onclick="showinfo()" >Message from counsellor</button><hr />
   ...
   <br> <input name="submit" type="submit" name="submit"  value="Submit" align="center" />
	 ...
	 <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                      ...
                      <input class="btn btn-warning" name="submit" type="submit" name="submit"  value="Send Message" align="center" />
                    </div>
