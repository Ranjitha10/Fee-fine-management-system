...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Details of   <?php 
$hostname="localhost"; 
$username="root"; 
$password=""; 
$database="ots";
...
$selected = mysql_select_db("ots",$dbhandle) 
  ...
  $sql = "SELECT `fname` FROM `student` WHERE usn = '$usn' ";
  $ret = mysql_query($sql);
...
$selected = mysql_select_db("ots",$dbhandle) 
  ...
  $sql = "SELECT `feetype`,`challan`,`challandate`,`amount` FROM `feepayment` WHERE usn = '$usn' ";
  $ret = mysql_query($sql);
...
$selected = mysql_select_db("ots",$dbhandle) 
  ...
  $sql = "SELECT `finetype`,`challan`,`challandate`,`amount` FROM `finepayment` WHERE usn = '$usn' ";
  $ret = mysql_query($sql);
  while($row = mysql_fetch_assoc($ret)){
