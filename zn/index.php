...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Welcome <?php session_start();$a=$_SESSION["fname"];  echo $a;?> </h4>
            ...
            <div class="row">
                <a href="forms1.php"> <div class="col-md-4 col-sm-4 col-xs-7">
  ...
  <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                        ...
                        <h5>Fee/Fine Payment </h5>
                    </div></a>
                </div>
                <a href="table.php"> <div class="col-md-4 col-sm-4 col-xs-7">
  ...
  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
                ...
                <a href="noti.php"><div class="col-md-4 col-sm-4 col-xs-7">
  ...
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
				...
				<?php
						      if(isset($_GET['error']))
							  {
								  ...
								  {echo "<html><head>";
					echo "<body>";
					echo "<script>function myfunction(){ window.alert('Payment Info Subbmited');}myfunction();</script>";
                   echo "</body></head></html>";}
